...
function makeState({ hands, top = null, namedSuit = null, current = 0, discard = [], deck = null, scores = [0, 0], events = [], seed = 1, lastPlayer = top ? 1 - current : null }) {
  ...
  return {
    ...
    current, drawn: null, roundOver: false, winner: null, skips: 0, lastPlayer,
  };
}
